...
this.instructionScreens = [
    ...
    showSurvivalCheckQuestion ()
    {
        ...
        this.addQuestionObject(this.add.text(250, 175,
            'Combien de morceaux de nourriture chaque personne a-t-elle besoin pour survivre à la journée ?',
            {
                fontSize: '30px',
                color: '#000000',
                align: 'center',
...
this.addQuestionObject(this.add.rectangle(640, 435, 1120, 350, 0xffffff))
        .setStrokeStyle(4, 0x000000);
