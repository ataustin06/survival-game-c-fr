...
redistributionRulesSelected: {
    ...
    this.foodCounts = {};
        ...
        this.instructionScreens = [
            ...
            "Aujourd’hui, la Personne A a récolté plus de 5 morceaux de nourriture, la Personne B a récolté exactement 5 morceaux de nourriture, et la Personne C a récolté moins de 5 morceaux de nourriture. \n \nIl arrive parfois que certaines personnes récoltent plus ou moins de nourriture qu’aujourd’hui.",
...
showRotatePhoneScreen (nextFunction)
{
    ...
    this.addQuestionObject(this.add.rectangle(640, 360, 1180, 430, 0xffffff))
    ...
    showSurvivalCheckQuestion ()
    {
        ...
        this.addQuestionObject(this.add.rectangle(640, 360, 1120, 450, 0xffffff))
            .setStrokeStyle(4, 0x000000);
    ...
    showSurvivalCheckFeedback (message)
    {
        ...
        this.addQuestionObject(this.add.rectangle(640, 360, 1120, 320, 0xffffff))
            .setStrokeStyle(4, 0x000000);
...
{
    const personA = this.foodCounts["Personne A"] ?? 5;
    const personB = this.foodCounts["Personne B"] ?? 5;
    const personC = this.foodCounts["Personne C"] ?? 0;
...
createAvatars ()
{
    ...
    const personA = this.createHumanAvatar(170, baselineY, "Personne A", 1.08, 0xcc3333, currentFood.personA);
    const personB = this.createHumanAvatar(450, baselineY, "Personne B", 1.00, 0x3366cc, currentFood.personB);
    const personC = this.createHumanAvatar(730, baselineY, "Personne C", 1.00, 0x339966, currentFood.personC);
...
showEqualDivisionTask ()
{
    ...
    this.personDropZones = {
        "Personne A": this.add.rectangle(260, baselineY + 35, 220, 280, 0xffffff, 0),
        "Personne B": this.add.rectangle(640, baselineY + 35, 220, 280, 0xffffff, 0),
        "Personne C": this.add.rectangle(1020, baselineY + 35, 220, 280, 0xffffff, 0)
    };
...
createEqualDivisionFoodPieces (totalFood)
{
    ...
    const basketInfo = {
        "Personne A": { x: 260, y: this.equalDivisionBaselineY, scale: 1.05 },
        "Personne B": { x: 640, y: this.equalDivisionBaselineY, scale: 1.00 },
        "Personne C": { x: 1020, y: this.equalDivisionBaselineY, scale: 0.90 }
    };
        ...
        food.on('dragend', () => {
            ...
            )
            {
                ...
                this.gameData.equalDivisionFinal = {
                    personA: this.equalDivisionCounts["Personne A"],
                    personB: this.equalDivisionCounts["Personne B"],
                    personC: this.equalDivisionCounts["Personne C"]
                };
...
showPerCapitaQuestion ()
{
    ...
    this.addQuestionObject(this.add.text(140, 170,
...
showGroupDistributionPreferenceQuestion ()
{
    ...
    this.addQuestionObject(this.add.rectangle(640, 460, 1180, 340, 0xffffff))
        .setStrokeStyle(4, 0x000000);
...
showRedistributionRulesQuestion ()
{
    ...
    this.addQuestionObject(this.add.rectangle(640, 360, 1200, 520, 0xffffff))
        .setStrokeStyle(4, 0x000000);
...
showUpperClassRedistributionQuestion ()
{
    ...
    this.addQuestionObject(this.add.rectangle(640, 450, 1180, 350, 0xffffff))
        .setStrokeStyle(4, 0x000000);
...
showSocialContractQuestion ()
{
    ...
    this.addQuestionObject(this.add.rectangle(640, 360, 1200, 500, 0xffffff))
        .setStrokeStyle(4, 0x000000);
...
showFoodRankReminderScreen ()
{
    ...
    this.addQuestionObject(this.add.rectangle(640, 360, 1180, 520, 0xffffff))
        .setStrokeStyle(4, 0x000000);

    this.addQuestionObject(this.createStaticHumanAvatar(280, 185, "Personne A", 1.12, 0xcc3333, personADisplayFood));
    this.addQuestionObject(this.createStaticHumanAvatar(640, 185, "Personne B", 1.00, 0x3366cc, personBDisplayFood));
    this.addQuestionObject(this.createStaticHumanAvatar(1000, 185, "Personne C", 0.88, 0x339966, personCDisplayFood));
...
showFoodPriorityQuestion ()
{
    ...
    this.addQuestionObject(this.add.rectangle(640, 455, 1180, 350, 0xffffff))
        .setStrokeStyle(4, 0x000000);
...
showWorkBreakQuestion ()
{
    ...
    this.addQuestionObject(this.add.rectangle(640, 465, 1200, 360, 0xffffff))
        .setStrokeStyle(4, 0x000000);
...
showFloodRiskInstructionScreen ()
{
    ...
    this.addQuestionObject(this.add.rectangle(640, 360, 1200, 560, 0xffffff))
        .setStrokeStyle(4, 0x000000);
...
showPersonDShareQuestion ()
{
    ...
    this.addQuestionObject(this.add.rectangle(640, 425, 1200, 300, 0xffffff))
        .setStrokeStyle(4, 0x000000);
...
showPersonDEmpathyQuestion ()
{
    ...
    this.addQuestionObject(this.add.rectangle(640, 450, 1200, 350, 0xffffff))
        .setStrokeStyle(4, 0x000000);
...
showCooperationCompetitionQuestion ()
{
    ...
    this.addQuestionObject(this.add.rectangle(640, 455, 1200, 360, 0xffffff))
        .setStrokeStyle(4, 0x000000);
...
createNextButton (x, y, label, callback)
{
    ...
    const buttonWidth =
    label === "Commencer le jeu" ? 300 : 160;
